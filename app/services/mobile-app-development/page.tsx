...
export const metadata: Metadata = {
  title: 'Mobile App Development | iOS, Android & Cross-Platform Engineering',
  description: 'Build secure, high-performance mobile apps. Native iOS/Android, cross-platform development, backend architecture, optimization & deployment services.',
  keywords: 'mobile app development USA, iOS app development, Android developers, cross platform apps, Flutter development, React Native app development',
};
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-8">
          ...
          <div className="max-w-5xl">
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6">
              Mobile apps must be fast, intuitive, secure, and built for scale. We develop <span className="font-semibold text-foreground">native and cross-platform apps</span> designed for seamless performance and long-term maintainability.
            </p>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              We develop high-performance mobile applications engineered for usability, security, and scale.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6 gradient-text">
                Mobile Experiences Users Trust
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We build mobile experiences users trust. From native iOS and Android to cross-platform solutions, every app is engineered for performance, security, and user satisfaction.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 p-12 rounded-3xl border-2 border-primary/30">
              <p className="text-2xl md:text-3xl font-bold text-foreground leading-relaxed">
                We build <span className="gradient-text">mobile experiences users trust</span>.
              </p>
            </div>
          </div>
        </div>
