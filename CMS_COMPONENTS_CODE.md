# CMS COMPONENTS - COPY THESE TO THE RESPECTIVE FILES

## components/cms/ColumnRenderer.tsx
...
## components/cms/WidgetRenderer.tsx
...
## components/cms/widgets/TextWidget.tsx
...
## components/cms/widgets/ImageWidget.tsx
...
## components/cms/widgets/ButtonWidget.tsx
...
## components/cms/widgets/SpacerWidget.tsx
...
For each file above, copy the code (inside the triple backticks) into the corresponding file in your project.

You can do this manually or run:

```bash
# Use your code editor to copy each section into the respective file
```
